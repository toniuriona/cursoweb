...
//  echo strlen($texto); //Cuenta los caracteres totales del string
 echo substr($texto, 5, 15); //Recorta la cadena de texto en este caso del primer string hasta el quinto. Podriamos almacenarlo en otra variable
